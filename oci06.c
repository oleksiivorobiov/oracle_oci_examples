...
/*
   ...
   DESCRIPTION
     ...
     Tests array fetch of just one table
   MODIFIED   (MM/DD/YY)
 ...
 *
 * Based on:    oci04.c
 * Changes:     added array features
 *              where clause has :tabname
 *              changed ofetch to ofen for multiple rows
 *
 ...
 *      Define    -   odefin
 *      Execute   -   oexec
 *      Fetch     -   ofen               fetching multiple rows
 *      Close     -   oclose
 *      Logoff    -   olof
 *
