rem
rem $Header: oci07.sql 11-oct-2006.15:55:32 azhao Exp $
rem
...
create table test1 (this_col_name_is_30_chars_long number, two long,
                    three date, four char(10));
