...
# 64-bit client executables.  (It uses demo_rdbms.mk to build any
...
#
#    make -f demo_rdbms64.mk demos
#
# 2. A single OCI demo:
#
#    make -f demo_rdbms64.mk build EXE=demo OBJS="demo.o ..."
#    e.g. make -f demo_rdbms64.mk build EXE=oci02 OBJS=oci02.o
#
# 3. A single OCI demo with static libraries:
#
#    make -f demo_rdbms64.mk build_static EXE=demo OBJS="demo.o ..."
#    e.g. make -f demo_rdbms64.mk build_static EXE=oci02 OBJS=oci02.o
#
# 4. To re-generate shared library:
#
#    make -f demo_rdbms64.mk generate_sharedlib
#
# 5. All OCCI demos
#
#    make -f demo_rdbms64.mk occidemos
#
# 6. A single OCCI demo:
#
#    make -f demo_rdbms64.mk <demoname>
#    e.g. make -f demo_rdbms64.mk occidml
#    OR
#    make -f demo_rdbms64.mk buildocci EXE=demoname OBJS="demoname.o ..."
#    e.g. make -f demo_rdbms64.mk buildocci EXE=occidml OBJS=occidml.o
#
# 7. A single OCCI demo with static libraries:
#
#    make -f demo_rdbms64.mk buildocci_static EXE=demoname OBJS="demoname.o ..."
#    e.g. make -f demo_rdbms64.mk buildocci_static EXE=occiblob OBJS=occiblob.o
#
# 8. All OCI Connection Pooling, Session Pooling and Statement Cache demos
#
#    make -f demo_rdbms64.mk cpdemos
#
# 9. A single OCI Connection Pooling demo:
#
#    make -f demo_rdbms64.mk <demoname>
#    e.g. make -f demo_rdbms64.mk cdemocp
#    OR
#    make -f demo_rdbms64.mk buildcp EXE=demoname OBJS="demoname.o ..."
#    e.g. make -f demo_rdbms64.mk buildcp EXE=cdemocp OBJS=cdemocp.o
#
# 10. A single OCI Connection Pooling demo with static libraries:
#
#    make -f demo_rdbms64.mk buildcp_static EXE=demoname OBJS="demoname.o ..."
#    e.g. make -f demo_rdbms64.mk buildcp_static EXE=cdemocp OBJS=cdemocp.o
#
# 11. A single OCI Session Pooling demo:
#
#    make -f demo_rdbms64.mk <demoname>
#    e.g. make -f demo_rdbms64.mk cdemosp
#    OR
#    make -f demo_rdbms64.mk buildcp EXE=demoname OBJS="demoname.o ..."
#    e.g. make -f demo_rdbms64.mk buildcp EXE=cdemosp OBJS=cdemosp.o
#
# 12. A single OCI Session Pooling demo with static libraries:
#
#    make -f demo_rdbms64.mk buildcp_static EXE=demoname OBJS="demoname.o ..."
#    e.g. make -f demo_rdbms64.mk buildcp_static EXE=cdemosp OBJS=cdemosp.o
#
#
# 13. A single OCI Statement Cache demo:
#
#    make -f demo_rdbms64.mk <demoname>
#    e.g. make -f demo_rdbms64.mk cdemostc
#    OR
#    make -f demo_rdbms64.mk buildcp EXE=demoname OBJS="demoname.o ..."
#    e.g. make -f demo_rdbms64.mk buildcp EXE=cdemostc OBJS=cdemostc.o
#
# 14. A single OCI Statement Cache demo with static libraries:
#
#    make -f demo_rdbms64.mk buildcp_static EXE=demoname OBJS="demoname.o ..."
#    e.g. make -f demo_rdbms64.mk buildcp_static EXE=cdemostc OBJS=cdemostc.o
#
#
...
#
#    make -f demo_rdbms64.mk demos_dp
#
# 2. A single DIRECT PATH API demo:
#
#    make -f demo_rdbms64.mk build_dp EXE=demo OBJS="demo.o ..."
#    e.g. make -f demo_rdbms64.mk build_dp EXE=cdemdplp OBJS=cdemdplp.o
#
#
...
#
#    make -f demo_rdbms64.mk extproc_no_context SHARED_LIBNAME=libname 
#                                             OBJS="demo.o ..."
#    e.g. make -f demo_rdbms64.mk extproc_no_context SHARED_LIBNAME=epdemo.so
#                                             OBJS="epdemo1.o epdemo2.o"
#
# 3. A single external procedure demo where one or more 3GL routines use the 
#    "with context" argument:
#
#    make -f demo_rdbms64.mk extproc_with_context SHARED_LIBNAME=libname 
#                                             OBJS="demo.o ..."
#    e.g. make -f demo_rdbms64.mk extproc_with_context SHARED_LIBNAME=epdemo.so
#                                             OBJS="epdemo1.o epdemo2.o"
#    e.g. make -f demo_rdbms64.mk extproc_with_context 
#                       SHARED_LIBNAME=extdemo2.so OBJS="extdemo2.o"
#    e.g. or For EXTDEMO2 DEMO ONLY: make -f demo_rdbms64.mk demos
#
# 4. To link C++ demos:
#
#    make -f demo_rdbms64.mk cppdemos
#
# 1. A single OCI demo:
#
#    make -f demo_rdbms64.mk build_clntshared EXE=demo OBJS="demo.o ..."
#    e.g. make -f demo_rdbms64.mk build_clntshared EXE=oci02 OBJS=oci02.o
#
# Example for building OCI programs with no pthread dependency
#
# 1. A single OCI demo:
#
#    make -f demo_rdbms64.mk build_nopthread EXE=demo OBJS="demo.o ..."
#    e.g. make -f demo_rdbms64.mk build_nopthread EXE=oci02 OBJS=oci02.o
#
...
DEMO64_MAKEFILE = $(DEMO_DIR)/demo_rdbms64.mk
...
BUILD=build
$(DEMOS):
	$(MAKE) -f $(DEMO64_MAKEFILE) $(BUILD) EXE=$@ OBJS=$@.o

$(DEMOS_DP): cdemodp.c cdemodp0.h cdemodp.h
	$(MAKE) -f $(DEMO64_MAKEFILE) build_dp EXE=$@ OBJS=$@.o

cppdemos: $(CPPDEMOS)

$(CPPDEMOS):
	$(MAKE) -f $(DEMO64_MAKEFILE) buildcpp EXE=$@ OBJS=$@.o
...
$(OCCIDEMOS):
	$(MAKE) -f $(DEMO64_MAKEFILE) buildocci EXE=$@ OBJS=$@.o

$(OCCIOTTDEMOS):
	$(MAKE) -f $(DEMO64_MAKEFILE) occiott OCCIOTTFILE=$@
	$(MAKE) -f $(DEMO64_MAKEFILE) buildocci EXE=$@ OBJS="$@.o $@o.o $@m.o"

# OTT Markers Support
$(OCCIOTTDEMOSWITHMARKER):
	$(MAKE) -f $(DEMO64_MAKEFILE) ott_mrkr OTTFILE=$@
	$(MAKE) -f $(DEMO64_MAKEFILE) buildocci EXE=$@ OBJS="$@.o $@o.o $@m.o"
...
cpdemos:	$(CPDEMOS)
$(CPDEMOS):
	$(MAKE) -f $(DEMO64_MAKEFILE) buildcp EXE=$@ OBJS=$@.o
buildcp: $(OBJS)
	$(MAKECPSHAREDDEMO64)
buildcp_static: $(OBJS)
	$(MAKECPSTATICDEMO64)
...
.pc.c:
	$(MAKE) -f $(DEMO64_MAKEFILE) PCCSRC=$* I_SYM=include= pc1
...
extdemo2:
	$(MAKE) -f $(DEMO64_MAKEFILE) extproc_with_context SHARED_LIBNAME=extdemo2.so OBJS="extdemo2.o"

extdemo4:
	$(MAKE) -f $(DEMO64_MAKEFILE) extproc_with_context SHARED_LIBNAME=extdemo4.so OBJS="extdemo4.o"

extdemo5:
	$(MAKE) -f $(DEMO64_MAKEFILE) extproc_with_context SHARED_LIBNAME=extdemo5.so OBJS="extdemo5.o"

extdemo6:
	$(MAKE) -f $(DEMO64_MAKEFILE) extproc_with_context SHARED_LIBNAME=extdemo6.so OBJS="extdemo6.o"
