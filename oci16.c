...
/*
   ...
   DESCRIPTION
     ...
     Tests array insert with autocommit on/off demonstration
   MODIFIED   (MM/DD/YY)
 ...
 *              User presses enter at each cycle. Autocommit is turned
 *              at each odd pass and turned on at each even pass
 *
 * Based on:    oci15.c
...
text *sqlstmt = (text *)"INSERT INTO oci16tab (col1) values (:col1)";
 ...
 * Function: logoff
 *
 * Description: This routine toggles between turning autocommit off and on
 *              with each pass.
 *
 */
void toggle_autocommit()
