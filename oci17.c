...
/*
   ...
   DESCRIPTION
     ...
     Tests array insert with demonstration of commit/rollback
   MODIFIED   (MM/DD/YY)
 ...
 *              User presses enter at each cycle. Commit and rollback
 *              on every other pass.
 *
 * Based on:    oci15.c
 * Changes:     user to press enter after each cycle
 *              added ocom and orol calls
 *
...
text *sqlstmt = (text *)"INSERT INTO oci17tab (col1) values (:col1)";
...
/*
 * Function: toggle_com_rol
 *
 * Description: This routine toggles between rollback and commit calls
 *              with each pass.
 *
 */
void toggle_com_rol()
